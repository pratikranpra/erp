 ...
 * @property customerDocument[] $customerDocuments
 * @property customerDetail[] $customerDetails
 * @property customerDocument[] $customerDocuments
 * @package App
...
class Customer extends Model
{
    ...
    {
        return $this->hasMany(\App\Models\customerDetail::class, 'id', 'customer_id');
    }
    ...
    {
        return $this->hasMany(\App\Models\customerDocument::class, 'id', 'customer_id');
    }
