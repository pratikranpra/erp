<x-app-layout :title="__('Add Company')">
    <x-slot name="header">
                ...
                <div class="w-full">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-gray-900">{{ __('Create') }} Company</h1>
                            <p class="mt-2 text-sm text-gray-700">Add a new {{ __('Company') }}.</p>
                        </div>
