<x-app-layout :title="__('Edit Vendor')">
    <x-slot name="header">
                ...
                <div class="w-full">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-gray-900">{{ __('Update') }} Vendor</h1>
                            <p class="mt-2 text-sm text-gray-700">Update existing {{ __('Vendor') }}.</p>
                        </div>
