<div class="space-y-6">
    ...
    <div class="flex gap-4">
        <div class="flex-1 min-w-0">
            ...
            <x-text-input id="gst_range_min" name="gst_range_min" type="number" min="1" max="99"
            class="mt-1 block w-full"
            :value="old('gst_range_min', $gstMaster?->gst_range_min)"
            autocomplete="gst_range_min" placeholder="Gst Range" />
            <x-input-error class="mt-2" :messages="$errors->get('gst_range_min')" />
        </div>
        <div class="flex-1 min-w-0">
            <x-input-label for="gst_range_max" :value="__('Gst Range')" />
            <x-text-input id="gst_range_max" name="gst_range_max" type="number" min="1" max="100"
            class="mt-1 block w-full"
            :value="old('gst_range_max', $gstMaster?->gst_range_max)"
            autocomplete="gst_range_max" placeholder="Gst Range" />
