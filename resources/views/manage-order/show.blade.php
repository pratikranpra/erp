<x-app-layout :title="__('Show Order')">
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ $manageOrder->name ?? __('Show') . " " . __('Manage Order') }}
        </h2>
    </x-slot>
                ...
                <div class="w-full">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-gray-900">{{ __('Show') }} Manage Order</h1>
                            <p class="mt-2 text-sm text-gray-700">Details of {{ __('Manage Order') }}.</p>
                        </div>
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-100">
                                                @foreach ($orderItemLists  as $key=>$single_order_item) 
                                                  <tr>
                                                    ...
                                                    <td class="px-4 py-2">{{ $single_order_item->vendor_name !=""?$single_order_item->vendor_name:"In-House" }}</td>
                                                    <td class="px-4 py-2">
